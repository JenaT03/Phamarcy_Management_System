                                    ...
                                    <div class="rounded position-relative fruite-item border border-secondary rounded">
                                        ...
                                        <div class="">
                                            <div class="fruite-img">
                                                <img src="{{$product->img ? asset('upload/products/' .$product->img) : asset('upload/products/default.png') }}" class="img-fluid w-100 rounded-top" alt="" />
                                            </div>
                                            <div class="p-4">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-0"><span
                                                            style="color: red">{{$product->productdetails->first()->price ?? '0'}}đ</span> {{$product->unit ? '/' . $product->unit : '' }}</p>
