...
<div class=" container">
        ...
        <form action="{{route('staffs.update', $staff->id )}}" method="POST">
            ...
            <div class="form-item col-md-6 offset-md-3 pb-3 my-3">
                ...
                <input type="text" class="form-control" name="staff_number" value="{{$staff->staff_number}}" readonly>
            ...
            <div class="form-item col-md-6 offset-md-3 pb-3 my-3">
                ...
                <input type="text" class="form-control" name="birth" value="{{old('birth') ?? $staff->birth}}">
                @error('birth')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-item col-md-6 offset-md-3 pb-3 my-3">
                ...
                <div class="d-flex">
                    ...
                    <input type="radio" class="me-2 form-check-input" value="Nam" name="gender" {{$staff->gender == 'Nam' ? 'checked' : '' }}>
                    <label class="form-label me-4">Nam</label>
                    <input type="radio" class="me-2 form-check-input" value="Nữ" name="gender" {{$staff->gender == 'Nữ' ? 'checked' : '' }}>
            ...
            <div class="form-item col-md-6 offset-md-3 pb-3 my-3">
                ...
                <textarea name="address" class="form-control" cols="30" rows="6" spellcheck="false">{{ old('address') ?? $staff->address }}</textarea>
