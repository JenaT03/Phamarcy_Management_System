...
<div class="container-fluid py-5">
        <div class="container py-5">
           <div class="d-flex justify-content-around mb-5">
                <a href="{{route('receipts.create')}}" class="btn btn-primary text-white py-4 px-3">Nhập hàng</a>
            ...
            <div>
                ...
                <p class="text-center">Không tìm thấy nhân viên nào có mã "{{ $search }}".</p>
                @endif
                <table class="table hid-border-style">
                    ...
                    <tbody class="border-bottom">
                        ...
                        <tr class="text-center border-top">
                            <td class="py-5">{{$receipt->name}}</td>
                            <td class="py-5">{{$receipt->country}}</td>
                             <td class="py-5 d-flex justify-content-around">
                                    <a href="{{route('receipts.edit', $receipt->id)}}" class="btn"><i class="fa-solid fa-pen text-primary"
