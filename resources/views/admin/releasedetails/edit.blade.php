                ...
                <form action="{{ route('releasedetails.update', $releaseDetail->id) }}" method="POST">
                    ...
                    <div class="form-item col-md-8 offset-md-2 pb-3 my-3">
                        ...
                        <input type="number" class="form-control" name ="quantity"
                            value="{{ old('quantity') ?? $releaseDetail->quantity }}" min="1">
                        @error('quantity')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-item col-md-8 offset-md-2 pb-3 my-3">
                        ...
                        <textarea name="note" class="form-control" cols="30" rows="6" spellcheck="false">{{ old('note') ?? $releaseDetail->note }}</textarea>
                    </div>
