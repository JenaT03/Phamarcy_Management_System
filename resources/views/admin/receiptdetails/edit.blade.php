                ...
                <form action="{{ route('receiptdetails.update', $receiptDetail->id) }}" method="POST">
                    ...
                    <div class="form-item col-md-8 offset-md-2 pb-3 my-3">
                        ...
                        <input type="text" class="form-control" name ="product_code"
                            value="{{ old('product_code') ?? $receiptDetail->product_code }}">
                        @error('product_code')
                    ...
                    <div class="form-item col-md-8 offset-md-2 pb-3 my-3">
                        ...
                        <input type="number" class="form-control" name ="quantity"
                            value="{{ old('quantity') ?? $receiptDetail->quantity }}" min="1">
                        @error('quantity')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-item col-md-8 offset-md-2 pb-3 my-3">
                        ...
                        <input type="number" class="form-control" name ="original_price"
                            value="{{ old('original_price') ?? $receiptDetail->original_price }}">
                    ...
                    <div class="form-item col-md-8 offset-md-2 pb-3 my-3">
                        ...
                        <input type="number" class="form-control" name ="selling_price"
                            value="{{ old('selling_price') ?? $receiptDetail->selling_price }}">
                        @error('selling_price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-item col-md-8 offset-md-2 pb-3 my-3">
                        ...
                        <input type="date" class="form-control" name ="expiry"
                            value="{{ old('expiry') ?? $receiptDetail->expiry }}">
                        @error('expiry')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-around">
                        <button type="submit" name="submit" class="btn btn-primary text-white text-center"
                            style="padding: 10px 35px;">Cập nhật</button>
                    </div>
                </form>
            </div>
