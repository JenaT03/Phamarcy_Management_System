        ...
        @if (!$customer)
            <form action="{{ route('releases.update', $release->id) }}" method="POST">
                ...
                <div class="form-item col-md-6 offset-md-3 pb-3 my-3">
                    ...
                    <input type="text" class="form-control" name="datetime" value="{{ $release->datetime }}" readonly>
                </div>

                <div class="form-item col-md-6 offset-md-3 pb-3 my-3">
                    <label class="form-label">Ghi chú</label>
                    <textarea name="note" class="form-control" cols="30" rows="6" spellcheck="false">{{ old('note') ?? $release->note }}</textarea>
