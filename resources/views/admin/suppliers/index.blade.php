...
<div class="container-fluid py-5">
        <div class="container py-5">
           <div class="d-flex justify-content-around mb-5">
                <a href="{{route('suppliers.create')}}" class="btn btn-primary text-white py-4 px-3">Thêm nhà cung cấp mới</a>
                <form method="GET" class="d-flex ms-5 search-form" name="search"  action="{{ route('suppliers.index') }}">
                    <input class="form-control me-2 rounded-pill" type="search" name="search" placeholder="Nhập tên nhà cung cấp để tìm" aria-label="Search">
                        ...
                        <tr class="text-center border-top">
                            ...
                            <td class="py-5">{{$supplier->phone}}</td>
                             ...
                             <td class="py-5 d-flex justify-content-around">
                                    <a href="{{route('suppliers.edit', $supplier->id)}}" class="btn"><i class="fa-solid fa-pen text-primary"
