    ...
    <div class="container-fluid py-5 ">
        <div class="container pb-5 ">
            <div class="d-flex justify-content-between">
                <a href="{{ route('customers.show', $customerId) }}" class="btn btn-primary py-2 px-3 text-white fs-5">
            ...
            <div class="d-flex justify-content-around mb-5">
                <form method="GET" class="d-flex ms-5 search-form" name="search" action="{{ route('customers.show-detail',['customer' => $customerId, 'release' => $release->id]) }}">
